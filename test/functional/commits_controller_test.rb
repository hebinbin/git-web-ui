...
class CommitsControllerTest < ActionController::TestCase
  ...
  test "should create commit" do
    assert_difference('Commit.count') do
      post :create, commit: { committed_date: @commit.committed_date, committer: @commit.committer, id: @commit.id, message: @commit.message, ticket: @commit.ticket }
    end
  ...
  test "should update commit" do
    put :update, id: @commit, commit: { committed_date: @commit.committed_date, committer: @commit.committer, id: @commit.id, message: @commit.message, ticket: @commit.ticket }
    assert_redirected_to commit_path(assigns(:commit))
  end
